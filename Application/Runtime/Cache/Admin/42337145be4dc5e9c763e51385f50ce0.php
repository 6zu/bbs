...
<html>
  ...
  <div class="header">
      ...
      <ul class="headermenu">
          <li><a  menuid="4" onclick="menu(1)">传智后台</a></li>
		  <li><a  menuid="4" onclick="menu(2)">技术论坛</a></li>
    ...
    <div id="menu1">
        ...
        <ul class="left-menu">
          <li>
            ...
            <ul class="son">
			  ...
			  <span><a href="">课程管理</a></span>
            <ul class="son">
              <li><a href="/index.php/admin/School/class_add" target="opt">添加班级</a></li>
              <li><a href="/index.php/admin/School/class_list" target="opt">班级列表</a></li>
              

			<span><a href="">阶段分类</a></span>
            <ul class="son">
			<li><a href="/index.php/admin/School/stage_add" target="opt">添加阶段</a></li>
              <li><a href="/index.php/admin/School/stage_list" target="opt">阶段列表</a>  </li>
		...
		<ul class="left-menu">
		 <li>
          ...
          <ul class="son">
              <li><a href="/index.php/admin/School/teacher_add" target="opt">教师添加</a></li>
              <li><a href="/index.php/admin/School/teacher_list" target="opt">教师列表</a></li>
            </ul>
		  </li>
          <li>
