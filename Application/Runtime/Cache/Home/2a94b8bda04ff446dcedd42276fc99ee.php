...
<td>&nbsp;<a href="/index.php/home/public/pv" class="xi2 xw1">折线图</a></td>
<td>&nbsp;<a href="/index.php/home/public/zhu" class="xi2 xw1">柱图</a></td>
<td>&nbsp;<a href="/index.php/home/public/pie" class="xi2 xw1">饼图</a></td>
</tr>
</table>
...
<?php
    ...
    <div class="top1">
        ...
        <p class="fr">
		   ...
		   &nbsp;<a href="/index.php/home/public/pv" class="xi2 xw1">折线图</a>
		   &nbsp;<a href="/index.php/home/public/zhu" class="xi2 xw1">柱图</a>
           &nbsp;<a href="/index.php/home/public/pie" class="xi2 xw1">饼图</a>
      ...
      <!--    
        ...
        <li><a href="http://bbs.itcast.cn" target="_blank">技术论坛 </a></li>
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li  id="nav_videodl"><a href="<?php echo ($vo["nav_url"]); ?>" ><?php echo ($vo["nav_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
             <li  id="nav_videodl"><a href="http://www.discuz.com/upload" target='blank'>技术论坛</a></li>
</ul>
        </div>
...
<div>
<img src="http://v.t.qq.com/share/images/s/weiboicon16.png" align="absmiddle" border="0" alt="转播到腾讯微博" /> <a href="javascript:void(0)" onclick="postToWb();return false;">转播到腾讯微博</a><script type="text/javascript">
	function postToWb(){
		var _url = encodeURIComponent(document.location);
		var _assname = encodeURI("");//你注册的帐号，不是昵称
		var _appkey = encodeURI("801552826");//你从腾讯获得的appkey
 ...
 <a title="更多平台" class="bshare-more bshare-more-icon more-style-addthis"></a>分享到：
...
<ul class="huodong11">
    <?php if(is_array($data3)): $i = 0; $__LIST__ = $data3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><img src="/Public/images/sanjiao-1.jpg" />
        <a href="/Home/Index/article_detail?id=<?php echo ($vo["college_article_id"]); ?>" target="_blank">
